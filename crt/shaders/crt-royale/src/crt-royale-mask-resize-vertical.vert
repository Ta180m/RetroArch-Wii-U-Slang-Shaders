...
void main()
{
   gl_Position = global . MVP * Position;
        vec2 tex_uv = TexCoord;
          ...
          float viewport_y = params . OutputSize . xy . y / mask_resize_viewport_scale . y;
          float aspect_ratio = global . geom_aspect_ratio_x / global . geom_aspect_ratio_y;
             ...
             vec2(viewport_y * aspect_ratio, viewport_y);
               ...
               vec2 estimated_mask_resize_output_size =
             vec2(params . OutputSize . xy . y * aspect_ratio, params . OutputSize . xy . y);


         vec2 mask_resize_tile_size = get_resized_mask_tile_size(
        estimated_viewport_size, estimated_mask_resize_output_size, false);
         vec2 pass_output_tile_size = vec2(min(
        mask_resize_src_lut_size . x, params . OutputSize . xy . x), mask_resize_tile_size . y);
