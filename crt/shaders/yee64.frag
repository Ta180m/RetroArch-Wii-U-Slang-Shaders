...
void main()
{
 ...
 vec4 c3 = vec4(- 1., 0.5, 1.25, 0.);
 vec4 c4 = vec4(0.5, - 0.5, 1.5, - 3.);
 vec4 c5 = vec4(- 1., 1., - 2., 2.);
 vec4 c6 = vec4(- 3., - 8., 720., 0.166666672);
 vec4 c7 = vec4(- 0.333000004, - 0.666000009, 0.899999976, 1.20000005);
 vec4 c8 = vec4(1.5, 0.5, 2.5, 0.899999976);
