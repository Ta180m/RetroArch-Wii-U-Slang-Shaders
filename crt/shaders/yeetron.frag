...
void main()
{
 ...
 vec4 c1 = params . SourceSize . xyzw;

 vec4 c2 = params . OutputSize . xyzw;


 vec4 c3 = vec4(1.5, 0.800000012, 1.25, 0.75);
 vec4 c4 = vec4(6.28318548, - 3.14159274, 0.25, - 0.25);
 vec4 c5 = vec4(1., 0.5, 720., 3.);
 vec4 c6 = vec4(0.166666672, - 0.333000004, - 0.666000009, 0.899999976);
 vec4 c7 = vec4(0.899999976, 1.10000002, 0., 0.);
 vec4 c8 = vec4(- 0.5, - 0.25, 2., 0.5);
