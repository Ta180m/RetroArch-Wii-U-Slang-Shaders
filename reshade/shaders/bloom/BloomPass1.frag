...
void main()
{
   ...
   vec2 offset[8] = vec2[8](vec2(vec2(1.0, 1.0)), vec2(vec2(0.0, - 1.0)), vec2(vec2(- 1.0, 1.0)), vec2(vec2(- 1.0, - 1.0)), vec2(vec2(0.0, 1.0)), vec2(vec2(0.0, - 1.0)), vec2(vec2(1.0, 0.0)), vec2(vec2(- 1.0, 0.0)
   ));
