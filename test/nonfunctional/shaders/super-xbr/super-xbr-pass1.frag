...
void main()
{
    ...
    vec4 w1 = vec4(-(1.0 * 1.75068 / 10.0),(1.0 * 1.75068 / 10.0)+ 0.5,(1.0 * 1.75068 / 10.0)+ 0.5, -(1.0 * 1.75068 / 10.0));
    vec4 w2 = vec4(-(1.0 * 1.29633 / 10.0 / 2.0),(1.0 * 1.29633 / 10.0 / 2.0)+ 0.25,(1.0 * 1.29633 / 10.0 / 2.0)+ 0.25, -(1.0 * 1.29633 / 10.0 / 2.0));
