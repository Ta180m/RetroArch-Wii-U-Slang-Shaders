...
void main()
{
 ...
 vec4 b =(yuv_weighted0 * mat4x3(B, D, H, F));
 vec4 c =(yuv_weighted0 * mat4x3(C, A, G, I));
 vec4 e =(yuv_weighted0 * mat4x3(E, E, E, E));
 vec4 d = b . yzwx;
 vec4 f = b . wxyz;
 vec4 g = c . zwxy;
 vec4 h = b . zwxy;
 ...
 vec4 i4 =(yuv_weighted0 * mat4x3(I4, C1, A0, G5));
 vec4 i5 =(yuv_weighted0 * mat4x3(I5, C4, A1, G0));
 vec4 h5 =(yuv_weighted0 * mat4x3(H5, F4, B1, D0));
 vec4 f4 = h5 . yzwx;
