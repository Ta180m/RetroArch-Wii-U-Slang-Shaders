...
#pragma parameterXBR_EDGE_STR¡2.00.05.00.2
...
void main()
{
  ...
  if(any(lessThan(fract(vTexCoord * params . SourceSize . xy / 8.0), vec2(0.5, 0.5))))
 {
  FragColor = texture(Source, vTexCoord);
 }
 else
 {
  vec2 tex =(floor(vTexCoord * params . SourceSize . xy / 8.0)+ vec2(0.5, 0.5))* 8.0 * params . SourceSize . zw;

  vec2 g1 = vec2(8.0 / params . SourceSize . x, 0.0);
  vec2 g2 = vec2(0.0, 8.0 / params . SourceSize . y);
