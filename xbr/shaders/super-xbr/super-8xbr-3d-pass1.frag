...
void main()
{
 ...
 vec2 dir = fract(vTexCoord * params . SourceSize . xy / 8.0)- vec2(0.5, 0.5);
  if((dir . x * dir . y)> 0.0)
 {
 ...
 else
 {
  ...
  vec2 g1 = vec2((8.0 / 2.0)/ params . SourceSize . x, 0.0);
  vec2 g2 = vec2(0.0,(8.0 / 2.0)/ params . SourceSize . y);
