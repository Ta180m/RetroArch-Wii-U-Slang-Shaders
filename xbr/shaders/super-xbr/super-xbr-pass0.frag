...
#pragma parameterXBR_EDGE_STR¡0.60.05.00.2
#pragma parameterXBR_WEIGHT¡1.00.001.500.01
...
void main()
{
 ...
 if(params . MODE == 1.0)
 {
  ...
  weight1 =(params . XBR_WEIGHT * 1.29633 / 10.0);
  weight2 =(params . XBR_WEIGHT * 1.75068 / 10.0 / 2.0);
 }
