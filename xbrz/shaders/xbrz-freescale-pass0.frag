...
void main()
{
  ...
  if(blendResult . z == 2 ||(blendResult . z == 1 &&
     ...
     (IsPixEqual(G, H)&& IsPixEqual(H, I)&& IsPixEqual(I, F)&& IsPixEqual(F, C)&& ! IsPixEqual(E, I)))))
 {
   ...
   if((2.2 * dist_F_G <= dist_H_C)&&(E != G)&&(D != G))
      FragColor . z += 16.0;

   if((2.2 * dist_H_C <= dist_F_G)&&(E != C)&&(B != C))
      FragColor . z += 64.0;
 }
  ...
  if(blendResult . w == 2 ||(blendResult . w == 1 &&
       ...
       (IsPixEqual(A, D)&& IsPixEqual(D, G)&& IsPixEqual(G, H)&& IsPixEqual(H, I)&& ! IsPixEqual(E, G)))))
 {
   ...
   if((2.2 * dist_H_A <= dist_D_I)&&(E != A)&&(B != A))
      FragColor . w += 16.0;

   if((2.2 * dist_D_I <= dist_H_A)&&(E != I)&&(F != I))
      FragColor . w += 64.0;
 }
  ...
  if(blendResult . y == 2 ||(blendResult . y == 1 &&
      ...
      (IsPixEqual(I, F)&& IsPixEqual(F, C)&& IsPixEqual(C, B)&& IsPixEqual(B, A)&& ! IsPixEqual(E, C)))))
 {
   ...
   if((2.2 * dist_B_I <= dist_F_A)&&(E != I)&&(H != I))
      FragColor . y += 16.0;

   if((2.2 * dist_F_A <= dist_B_I)&&(E != A)&&(D != A))
      FragColor . y += 64.0;
 }
  ...
  if(blendResult . x == 2 ||(blendResult . x == 1 &&
     ...
     (IsPixEqual(C, B)&& IsPixEqual(B, A)&& IsPixEqual(A, D)&& IsPixEqual(D, G)&& ! IsPixEqual(E, A)))))
 {
   ...
   if((2.2 * dist_D_C <= dist_B_G)&&(E != C)&&(F != C))
      FragColor . x += 16.0;

   if((2.2 * dist_B_G <= dist_D_C)&&(E != G)&&(H != G))
      FragColor . x += 64.0;
 }
 FragColor /= 255.0;
}
